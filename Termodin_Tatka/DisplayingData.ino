...
{
  if(MAIN_DEBUG) Serial.println("F:displayData_loop()");
  ...
  //Last Water Flow state
  if(waterFlowSensorCount_global > lastwaterFlowSensorCount_global || waterFlowDisplay_global == 0)
  {
...
{
  if(DISPLAY_DEBUG) Serial.print("DsiplayServiceMessage: ");
  if(DISPLAY_DEBUG) Serial.println(message);
